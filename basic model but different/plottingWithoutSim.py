...
plot_scatter(axes1[0, 1], data['local_density'], data['local_flow'], 'Density (cars/km)', 'Flow (cars/hour)', 'Local Flow vs. Density', 'red')
plot_scatter(axes1[0, 2], data['global_density'], data['global_average_velocity'], 'Density (cars/km)', 'Average Velocity (m/s)', 'Global Avg Velocity vs. Density', 'blue')
plot_scatter(axes1[1, 0], data['local_density'], data['local_average_velocity'], 'Density (cars/km)', 'Average Velocity (m/s)', 'Local Avg Velocity vs. Density', 'red')
plot_scatter(axes1[1, 1], data['global_flow'], data['global_average_velocity'], 'Flow (cars/hour)', 'Average Velocity (m/s)', 'Global Flow vs. Velocity', 'blue')
